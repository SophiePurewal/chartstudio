...
function sortDynamic(a, b2) {
  ...
  if (!a.parse && b2.parse) return 1;
  if (a.parse && b2.parse && (a.priority || b2.priority))
...
async function Dr(e, r, t) {
  ...
  return (
    C in t &&
      (a.push(I(e.base, C)), s.push(Ue(rr(e.base), await N(e, r, $e(t))))),
    v in t &&
      (a.push(I(e.base, v)), s.push(je(tr(e.base), await N(e, r, Qe(t))))),
...
function qt(e, r, t, n2) {
  let a = t.k;
  if (a.length > 0)
    for (let i = 0, u = t.v, l = a.length; i < l; i++) Xn(e, r, n2, a[i], u[i]);
  return n2;
}
function Qn(e, r, t) {
...
function Qt(e, r, t, n2) {
  return t
    ? F(e.base, t)
      ? (w$1(e.base, r), Ne(e, r, n2, m(e, t.i)), "")
      : f(e, t)
    : "";
}
function jo(e, r) {
...
function ca(e, r) {
  ...
  return (
    r.f.t !== 4 &&
      (w$1(e.base, r.f.i), (t = "(" + f(e, r.f) + ","), (n2 = true)),
...
function Zr(e, r, t) {
  ...
  return (
    ...
    v in t &&
      (a.push(I(e.base, v)),
      s.push(je(tr(e.base), E(e, r, e.type === 1 ? re() : Qe(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push($(t[P$1]))),
    R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)),
    { k: a, v: s }
  );
...
function ha(e, r, t) {
  if (this.state.alive) {
    let n2 = W(this, r, t);
    (n2 && se(this, c(23, e, o, o, o, o, o, [k(this.base, 2), n2], o, o, o, o)),
      be(this));
  }
}
function za(e, r, t) {
...
function _a(e, r, t, n2) {
  let a = zr(e.base, {});
  return (
    e.type === 2 && (Qr(e), n2.then(ha.bind(e, a, r), za.bind(e, a, r))),
    zt(e.base, t, a)
  );
}
function ka(e, r, t, n2, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    ...
    if (u.parse.sync && u.test(n2))
      return ce(t, u.tag, u.parse.sync(n2, new Kr(e, r), { id: t }));
  }
  return o;
}
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import("./_tanstack-start-manifest_v-Dtyx0-Sp.js");
...
async function transformManifestAssets(source, transformFn, _opts) {
  ...
  if (!(_opts?.inlineCss !== false)) delete manifest2.inlineCss;
    ...
    manifest2.inlineCss = await transformInlineCssStyles(
      manifest2.inlineCss,
      transformFn,
    );
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BLLD9CXl.js"),
    import("./start-Cm-OK-os.js"),
