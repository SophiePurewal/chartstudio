import {
  ...
  A as isNotFound,
  x as invariant,
  f as createControlledPromise,
  X as rootRouteId,
  E as isServer$1,
  d as compileDecodeCharMap,
  Z as trimPath,
  W as rewriteBasepath,
  e as composeRewrites,
  M as processRouteTree,
  L as processRouteMasks,
  V as resolvePath,
  c as cleanPath,
  $ as trimPathRight,
  K as parseHref,
  o as executeRewriteInput,
  y as isDangerousProtocol,
  P as redirect,
  s as findSingleMatch,
  j as deepEqual,
  D as DEFAULT_PROTOCOL_ALLOWLIST,
  b as buildRouteBranch,
  w as interpolatePath,
  J as nullReplaceEqualDeep,
  S as replaceEqualDeep$1,
  H as last,
  i as decodePath,
  q as findFlatMatch,
  r as findRouteMatch,
  v as hasKeys,
  p as executeRewriteOutput,
  l as encodePathLikeUrl,
  _ as trimPathLeft,
  F as joinPaths,
  a1 as useRouter,
  k as dummyMatchContext,
  I as matchContext,
  T as requireReactDom,
  n as exactPathTest,
  Q as removeTrailingSlash,
  R as React,
  G as jsxRuntimeExports,
  a0 as useHydrated,
  m as escapeHtml,
  z as isInlinableStylesheet,
  u as getAssetCrossOrigin,
  U as resolveManifestAssetLink,
  O as Outlet,
} from "./server-D0QWcPH9.js";
...
const runLoader = async (inner, matchPromises, matchId, index, route) => {
  try {
    const match = inner.router.getMatch(matchId);
    try {
      if (!(isServer$1 ?? inner.router.isServer) || match.ssr === true)
              ...
              const nextParams =
                maskParams === false || maskParams === null
                  ...
                  : (maskParams ?? true) === true
                    ...
                    : Object.assign(
                        params,
                        functionalUpdate$1(maskParams, params),
                      );
              maskedDest = {
                from: opts.from,
                ...maskProps,
  ...
  const parsed = reactExports.useMemo(() => {
    ...
    const rows = config.rows
      .filter(
        (r2) =>
          r2.label.trim() &&
          r2.values.some((v) => v.trim() && !isNaN(Number(v))),
      )
      .map((r2) => ({
        label: r2.label.trim(),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                children: "ChartStudio · Plugin preview",
              }),
            ],
          }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("main", {
                ...
                children: [
                  step === 1 &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Screen1, {
                      config,
                      update,
                      onPick: () => setStep(2),
                    }),
                  step === 2 &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Screen2, {
                      config,
                      update,
                      dataPoints,
                      seriesNames,
                  ...
                  step === 3 &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Screen3, {
                      config,
                      update,
                    }),
                  step === 4 &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Screen4, {
                      config,
                      update,
                      numSeries,
                  ...
                  step === 5 &&
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Screen5, {
                      config,
                      dataPoints,
                      seriesNames,
                      inserted,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewPanel, {
                config,
                data: dataPoints,
                seriesNames,
              ...
              helpOpen &&
                /* @__PURE__ */ jsxRuntimeExports.jsx(HelpDrawer, {
...
function Screen1({ config, update, onPick }) {
  const items = [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartThumb, {
                  type: it.id,
                }),
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
...
function ChartThumb({ type }) {
  ...
  if (type === "bar")
    return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", {
      viewBox: "0 0 80 50",
      className: "w-3/4",
      children: [28, 18, 36, 22, 30].map((h, i) =>
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: 6 + i * 14,
...
function Screen2({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Section, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Segmented, {
        value: config.mode,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                              onClick: () =>
                                setSeriesCount(currentSeriesCount - 1),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
                      ...
                      children: Array.from({ length: currentSeriesCount }).map(
                        (_, i) =>
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                ...
                children: [
                  ...
                  Array.from({ length: currentSeriesCount }).map((_, i) =>
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        className: "truncate",
                        children: config.seriesNames[i] || `S${i + 1}`,
                      },
                      i,
                    ),
                  ),
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
                          onClick: () =>
                            update({
                              rows: config.rows.filter((_, j) => j !== i),
                            }),
                          className:
                    ...
                    onClick: () =>
                      update({
                        rows: [
                          ...
                          {
                            label: "",
                            values: Array(currentSeriesCount).fill(""),
                          },
                        ],
                      }),
                    className:
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        ...
        children:
          parseErrors.length > 0
            ...
            : dataPoints.length >= 2
              ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Banner, {
                  tone: "success",
                  children: [
                    "Found ",
                    dataPoints.length,
...
function Screen3({ config, update }) {
...
function Screen4({ config, update, numSeries, sizeValidationMessage }) {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Select, {
              ...
              getLabel: (value) =>
                CHART_SIZE_OPTIONS.find((option) => option.id === value)
                  ?.label ?? value,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
            className: "text-[11px] text-muted-foreground",
            children: getChartSizeSummary(config),
          }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                ...
                sizeValidationMessage
                  ? /* @__PURE__ */ jsxRuntimeExports.jsx(Banner, {
                      tone: "error",
                      children: sizeValidationMessage,
                    })
                  : /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
                      className: "text-[11px] text-muted-foreground",
                      children:
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
              ...
              children: PALETTES[config.palette].slice(0, 10).map((c, i) =>
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Field, {
                  label: `Line weight · ${config.lineWeight}px`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Field, {
                  label: `Bar radius · ${config.barRadius}px`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, {
                    min: 0,
                    max: 8,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Field, {
                  label: `Inner radius · ${config.innerRadius}%`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, {
                    min: 30,
                    max: 70,
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        ...
        children: !config.type
          ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyPreview, {
              text: "Choose a chart type to see a preview.",
            })
          : data.length < 2
            ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyPreview, {
                text: "Add data to see preview.",
              })
            : warnings.length
              ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
                  className:
              ...
              : /* @__PURE__ */ jsxRuntimeExports.jsx(ChartRender, {
                  config,
                  data,
                  seriesNames,
                  expanded,
...
function ChartRender({ config, data, seriesNames, expanded, note }) {
              ...
              : /* @__PURE__ */ jsxRuntimeExports.jsx(
                  jsxRuntimeExports.Fragment,
                  {
                    children: (() => {
                      ...
                      const stacked =
                        config.barLayout === "stacked" && numSeries > 1;
                      const innerGap = 1.5;
                      ...
                      return data.map((d, i) => {
                        ...
                        if (stacked) {
                          ...
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            ...
                            {
                              children: [
                                Array.from({ length: numSeries }).map(
                                  (_, sIdx) => {
                                    const v = Number(d.values[sIdx]) || 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            style: { width: size + 90, height: size },
            className: "shrink-0",
            children:
...
function arcPath(cx, cy, r2, ir, start, end) {
  ...
  const x1 = cx + r2 * Math.cos(start),
    y1 = cy + r2 * Math.sin(start);
  const x2 = cx + r2 * Math.cos(end),
    y2 = cy + r2 * Math.sin(end);
...
function Select({ value, options, onChange, getLabel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: "relative",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", {
        ...
        children: options.map((o) =>
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "option",
            { value: o, children: getLabel ? getLabel(o) : o },
            o,
          ),
        ),
      }),
...
function Banner({ tone, title, children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: cn("rounded-md border px-2.5 py-2 text-[11.5px]", styles),
    children: [
      title &&
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
